...
namespace Msg.Tools.ExpressionExtend
{
    public sealed class ParameterRebinder : ExpressionVisitor
    {
        ...
        public static Expression ReplaceParameters(Dictionary<ParameterExpression, ParameterExpression> map, System.Linq.Expressions.Expression exp)
        {
