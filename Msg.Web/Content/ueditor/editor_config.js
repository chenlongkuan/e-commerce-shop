...
(function () {
    ...
    var tmp = window.location.pathname,
           URL = 'http://localhost:23928/content/ueditor/';
    UEDITOR_CONFIG = {
        ...
        //catcherUrl: "/getRemoteImage.ashx", 
        separater: 'ue_separate_ue',               //提交至后台的远程图片地址字符串分隔符
        localDomain: "meisugou.com",                                        //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地
        ...
        'body{margin:8px;font-family:"微软雅黑";font-size:14px;}' + //此处进行默认字体和字号设置
        //针对li的处理
        'li{clear:both}' +
        //设置段落间距
        'p{margin:0px 0px;}',
